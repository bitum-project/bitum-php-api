...
class ExtendedKey
{
    ...
    /**
     * Bitum coin type index
     */
    const BITUM_COIN_TYPE = 20;
    ...
    public static function fromString($key)
    {
        ...
        $payload = BitumNetwork::extendedKeyBase58Decode($key);
     ...
     * @return ExtendedKey
     */
    public function deriveCoinTypeKey($coinType = self::BITUM_COIN_TYPE)
    {
